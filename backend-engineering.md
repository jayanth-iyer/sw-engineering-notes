# What to Study in Backend Engineering?

1. Event-Driven Architecture - Services talk via events.

2. Observability - Logging, Monitoring, Tracing.

3. Circuit Breakers - Prevent cascading failures.

4. Sharding and Partitioning - Distributing data across nodes.

5. Rate Limiting - Control traffic to services. Token Bucket.
...
5. Authentication.
    ...
    - Multi-factor Auth.
    - SSO (Single Sign-On).
6. [Java Interview Questions](https://x.com/SumitM_X/status/2009322749655925109)
...
12. [Tech is'nt dead, but skillsets have shifted](https://youtu.be/csyWs2mIzoc?si=mEWPD2FpI-hrvDR7)
    - How Models are trained?
    - What Embeddings represent?
    - How Loss Functions & Oppositions works at High Level?
    - The difference between Training and Inference?
    - How Data Quality impacts outputs?
    - Where Bias & Hallucinations come from?

13. [Dagger IO](https://dagger.io/)

14. [My Journey with Dagger.io](https://medium.com/@frank.ittermann_46267/part-2-my-journey-with-dagger-io-almost-perfect-but-not-quite-2bb3b645e938)
